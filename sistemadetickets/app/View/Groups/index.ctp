...
<!--                                <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> <?php echo __('Grupos de Trabajo');?> </h1> 
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus-square"></i> <?php  echo __('Nuevo Grupo');?></h4>
                  </div>
...
<!--  Modal Editar -->
   ...
   <div class="modal-body">
    ...
    <!-- Form EDITAR -->
                 ...
                 <?php echo $this->Form->create('Group', array( 'action'=>'edit' , 'id'=>'formEdit',
                         'class' => 'form-horizontal',  
                         'inputDefaults' => array(  
                         'format' => array('before', 'label', 'between', 'input', 'error', 'after'),  
                         'div' => array('class' => 'form-group'),  
                     ...
                     <fieldset>
                          <?php  
                            echo $this->Form->input('description', array('readonly'=>'readonly', 'label' => array('id'=>'description_edit','class' => 'col-md-4 control-label',
                                                                         'text'=>__('Descripción')), 'class' => 'form-control input-lg'));
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="listagrupos">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                         <?php foreach ($groups as $k =>$group): ?>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><?php echo $group['Group']['validity'] ?></td>
                                                    <td>
...
//                                                           array('confirm' => __('Realmente desea eliminar al grupo ') . $group['Group']['description']. '?',
