...
<!--                        <li class="sidebar-search">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                     <?php echo $this->Html->link(__(' Tipo de Tickets'), array('controller' => 'Groups', 'action' => 'index'),array('escape' => false)); ?>
                                </li>
                                <li>
...
<!--                                <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> <?php echo __('Tipo de Tickets');?> </h1> 
...
<!-- Modal Crear-->
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus-square"></i> <?php  echo __('Nuevo Tipo de Ticket');?></h4>
                  </div>
    ...
    <!-- Form Crear -->
                    ...
                    <?php echo $this->Form->create('TicketType', array('action'=>'add',  
                     ...
                     <fieldset>
                          <?php  
                            echo $this->Form->input('description', array('label' => array('class' => 'col-md-4 control-label',
  ...
  <!--INICIO TABLA-->
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <?php echo __('Listado de Tipos de Tickets ');?>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="listaroles">
                                    ...
                                    <tbody>
                                         <?php foreach ($tickettypes as $k =>$tickettype): ?>
    
                                                <tr class="odd gradeX">
                                                    <td><?php echo $tickettype['TicketType']['id'] ?></td>
                                                    <td><?php echo $tickettype['TicketType']['description'] ?></td>
                                                   
                                                    <td>
                                                        
                                                <?php 
                                                echo $this->Html->link($this->Html->tag('i', '', array('class' => 'glyphicon glyphicon-pencil')),
                                                     array('action'=>'edit',$tickettype['TicketType']['id']), 
...
//                                                           
//                                                           array('action' => 'delete', $tickettype['TicketType']['id']), 
//                                                           array('confirm' => __('Realmente desea eliminar al Tipo de Ticket ') . $tickettype['TicketType']['description']. '?',
