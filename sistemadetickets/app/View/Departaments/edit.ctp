 <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-pencil"></i><?php echo __(' Editar Departamento/Facultad'); ?>  </h4>
                  </div>
   ...
   <div class="modal-body">
    ...
    <!-- Form EDITAR -->
                 ...
                 <?php echo $this->Form->create('Departament', array( 'action'=>'edit' , 'id'=>'formEdit',
