...
<!--                                <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> <?php echo __('Departamentos o Facultades ESPOCH');?> </h1> 
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus-square"></i> <?php  echo __('Nuevo Departamento/Facultad');?></h4>
                  </div>
       
    <div class="modal-body">
 <!-- Form CREAR -->
  <?php echo $this->Form->create('Departament', array( 'action'=>'add',  'class' => 'form-horizontal',  
   ...
   <div class="modal fade" id="Edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-pencil"></i><?php echo __(' Editar Departamento'); ?>  </h4>
                  </div>
  <div class="modal-body">                 
    <!-- Form EDITAR -->
                 <?php echo $this->Form->create('Departament', array( 'action'=>'edit' , 'id'=>'formEdit', 'class' => 'form-horizontal',  
                         'inputDefaults' => array(     'format' => array('before', 'label', 'between', 'input', 'error', 'after'),  
                         'div' => array('class' => 'form-group'),  
                         'label' => array('class' => 'col-md-4 control-label'),  
                         'between' => '<div class="col-md-4">',  
  ...
  <!--INICIO TABLA-->
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <?php echo __('Listado de Departamentos/Facultades ESPOCH ');?>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="listadepartamentos">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                         <?php foreach ($departaments as $k =>$departament): ?>
                                                ...
                                                <tr class="odd gradeX">
                                                    <td><?php echo $departament['Departament']['id'] ?></td>
                                                ...
                                                <?php  echo $this->Html->link($this->Html->tag('i', '', array('class' => 'glyphicon glyphicon-pencil')),
                                                             array('action'=>'edit',$departament['Departament']['id']), 
                                                ...
                                                echo $this->Form->postLink($this->Html->tag('i', '', array('class' => 'glyphicon glyphicon-trash')), 
                                                           ...
                                                           array('action' => 'delete', $departament['Departament']['id']), 
                                                           array('confirm' => __('Realmente desea eliminar al Departamento ') . $departament['Departament']['description']. '?',
