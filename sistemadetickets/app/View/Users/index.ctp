...
<!--                                <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> <?php echo __('Usuarios');?> </h1> 
                    <?php echo $this->Session->flash() ?>
       <!--BOTON NUEVO USUARIO-->
                  
                    
                     <?php  echo $this->Html->link('<i class="fa fa-plus-square"></i> Nuevo',
                            array('action'=>'add'), 
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus-square"></i> <?php  echo __('Nuevo Usuario');?></h4>
                  </div>
   <div class="modal-body">
   <!-- Form Crear -->
     <?php echo $this->Form->create('User', array( 'action'=>'add',   'class' => 'form-horizontal', 'id'=>'formAdd',
                    ...
                    <fieldset>
                         <center>
                          ...
                          <?php  
                            echo $this->Form->input('name', array('label' => array('class' => 'col-md-4 control-label', 'text'=>__('* Nombre:')), 'class' => 'form-control input-md'));
                            echo $this->Form->input('lastname', array('label' => array('class' => 'col-md-4 control-label', 'text'=>__('* Apellido: ')), 'class' => 'form-control input-md'));
                            echo $this->Form->input('email', array('label' => array('class' => 'col-md-4 control-label', 'text'=>__('* Email: ')), 'class' => 'form-control input-md'));
                            echo $this->Form->input('phone', array('label' => array('class' => 'col-md-4 control-label', 'text'=>__('Télefono: ')), 'class' => 'form-control input-md'));
                            echo $this->Form->input('username', array(  'label' => array('class' => 'col-md-4 control-label', 'text'=>__('* Nombre de Usuario: ')), 'class' => 'form-control input-md'));
                            echo $this->Form->input('password', array( 'label' => array('class' => 'col-md-4 control-label', 'text'=>__('* Contraseña: ')), 'class' => 'form-control input-md'));
                            echo $this->Form->input('validity', array('class' => 'form-control',
                                                    'label'=>array('class' => 'col-md-4 control-label','text'=>__('Validez: ')), 
                                                    'options' => array('Válido'=>'Válido','Temporalmento no válido'=>'Temporalmento no válido','No válido'=>'No válido'),'empty' => '--Seleccione--' ));
                          
                           echo $this->Form->input('role_id', array ('id' =>'role' ,'class' => 'form-control', 'label'=>array('class' => 'col-md-4 control-label','text'=>__('* Rol:')) ,'options' => $roles, 'empty' => '--Seleccione  Rol--' ));
                           echo $this->Form->input('group_id', array('id' =>'group','class' => 'form-control',   'label'=>array('class' => 'col-md-4 control-label','text'=>__('* Grupo:')),  'options' => $groups,'empty' => '--Seleccione Grupo--' ));
                      ?>
                    </fieldset>
 <!-- /Form End Crear  -->             
<!--                   </form>-->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="listausers" style="font-size: 10px">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                         <?php foreach ($users as $k =>$user): ?>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td style="width: 55px"><?php echo $user['User']['username'] ?></td>
                                                    <td><?php echo $user['User']['validity'] ?></td>
                                                    <td><?php echo $user['Role']['description'] ?></td>
                                                    <td><?php echo $user['Group']['description'] ?></td>
                                                    <td style="width: 90px"><?php echo $user['User']['created'] ?></td>
...
//                                                                   array('confirm' => __('Realmente desea eliminar al Usuario ') . $user['User']['username']. '?',
