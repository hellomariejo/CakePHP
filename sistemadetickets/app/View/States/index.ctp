...
<!--                                <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> <?php echo __('Estados del Ticket');?> </h1> 
                    <?php echo $this->Session->flash() ?>
  <!--BOTON NUEVO USUARIO-->
                  
                    
                     <?php  
//                     echo $this->Html->link('<i class="fa fa-plus-square"></i> Nuevo',
//                            array('action'=>'add'), 
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus-square"></i> <?php  echo __('Nuevo Estado');?></h4>
                  </div>
   ...
   <div class="modal fade" id="Edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-pencil"></i><?php echo __(' Editar Estado'); ?>  </h4>
                  </div>
  <div class="modal-body">                 
    <!-- Form EDITAR -->
                 <?php echo $this->Form->create('State', array( 'action'=>'edit' , 'id'=>'formEdit', 'class' => 'form-horizontal',  
                         'inputDefaults' => array(     'format' => array('before', 'label', 'between', 'input', 'error', 'after'),  
                         'div' => array('class' => 'form-group'),  
                         'label' => array('class' => 'col-md-4 control-label'),  
                         'between' => '<div class="col-md-4">',  
  ...
  <!--INICIO TABLA-->
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <?php echo __('Listado de Estados del Ticket ');?>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="listaestados">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                         <?php foreach ($states as $k =>$state): ?>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><?php echo $state['State']['description'] ?></td>
...
//                                                           
//                                                           array('action' => 'delete', $state['State']['id']), 
//                                                           array('confirm' => __('Realmente desea eliminar al Estado ') . $state['State']['description']. '?',
